...
{
    public partial class Joder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InscriptosId = table.Column<int>(type: "int", nullable: false),
                    MateriasId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InscripcionMateria", x => new { x.InscriptosId, x.MateriasId });
                    table.ForeignKey(
                        name: "FK_InscripcionMateria_Inscripciones_InscriptosId",
                        column: x => x.InscriptosId,
                        principalTable: "Inscripciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InscripcionMateria_Materias_MateriasId",
